...
class PinDuoDuoOpen{
    ...
    const REQUEST_API_LIST_NEED_TOKEN = [
        'pdd.vas.order.search' => false,
        'pdd.goods.list.get' => true,
        'pdd.goods.detail.get' => true,
        'pdd.goods.information.update' => true,
        'pdd.goods.image.upload' => true,
        'pdd.goods.commit.detail.get' => true,
        'pdd.mall.info.get' => true,
    ];
...
//        $response = call_user_func_array([$http, 'post'], [self::URL, $params]);
    ...
    // 生成链接  执行pddapi
//    public function request1($method,$params=[]){
//        $params = $this->paramsHandle($params);
